...
export default function GetQuotePage() {
  ...
  const validate = () => {
    ...
    if (!form.projectTypes.length) newErrors.projectTypes = "Select at least one project type.";
    return newErrors;
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#3a2177] to-[#2d0e4a] flex flex-col items-center py-10">
      <div className="w-full max-w-4xl" style={{ borderRadius: '40px', overflow: 'hidden' }}>
        {/* Figma-style heading and breadcrumb */}
        <div className="flex flex-col items-center" style={{ marginTop: '129.4px', marginBottom: '40px' }}>
          <h1
        ...
        >
          ...
          {submitted ? (
            <div className="text-green-400 text-lg">Thank you! We will contact you soon.</div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  />
                  {errors.country && <span className="text-red-400 text-xs mt-1">{errors.country}</span>}
                </div>
              </div>
              <div className="flex flex-col">
                <textarea
                ...
                />
                {errors.project && <span className="text-red-400 text-xs mt-1">{errors.project}</span>}
              </div>
              <div>
                <div
                  className="mb-2"
                ...
                <div className="flex flex-wrap gap-2">
                  {['UI/UX Design','Software Development','AI Solutions','Digital Marketing','Devops Solutions','Quality Assurance'].map((type) => (
                    <button
                      type="button"
                      key={type}
                      ...
                      style={{
                        ...
                        borderRadius: '16px',
                        background: form.projectTypes.includes(type) ? '#6732D9' : 'transparent',
                        padding: '20px 32px',
                        margin: '8px 8px 0 0',
                ...
                {errors.projectTypes && <span className="text-red-400 text-xs mt-1 block">{errors.projectTypes}</span>}
              </div>
              <button
                type="submit"
            ...
            <div className="flex-1 flex flex-col gap-4" style={{marginTop: 0, marginBottom: 0}}>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <div style={{fontFamily: 'DM Sans, sans-serif', fontWeight: 700, fontSize: '18px', color: '#FFF', letterSpacing: '0.02em'}}>connect@codeswift.org</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mb-10">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="flex-1 text-white">
              <p>CodeSwift operates with a global presence, strategically based in both the United States and Pakistan. As a SaaS–based company, we deliver innovative, cloud-powered solutions that cater to businesses worldwide. Our teams in these two dynamic locations collaborate to create impactful solutions that drive growth, efficiency, and long–term success for our clients.</p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
          <div className="bg-[#3a2177]/60 rounded p-4 text-white border border-gray-400/50">
            <div className="font-bold mb-2">Global Coverage:</div>
            Seamless operations from the USA to Pakistan for enhanced support and service delivery.
          </div>
          <div className="bg-[#3a2177]/60 rounded p-4 text-white border border-gray-400/50">
            <div className="font-bold mb-2">Expert Teams:</div>
            Senior professionals dedicated to solving complex business challenges and offering tailored solutions.
          </div>
          <div className="bg-[#3a2177]/60 rounded p-4 text-white border border-gray-400/50">
            <div className="font-bold mb-2">Security First:</div>
            Flexible and secure partnerships, with NDA agreements available upon request to protect your business interests.
          </div>
        </div>
